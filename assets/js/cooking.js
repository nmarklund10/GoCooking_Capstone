...
function getGif(instruction) {
    ...
    else if(instruction.includes("dip chicken in egg mixture")) {
        return getStaticResource(path + 'chicken_egg_dipping.gif');
    }

    else if(instruction.includes("dip chicken in egg; then bread crumbs")) {
        return getStaticResource(path + 'chicken_breading.gif');
    }

    else if(instruction.includes("flatten chicken") || ("chicken to flatten") || ("pound")) {
        return getStaticResource(path + 'chicken_flattening.gif');
    }

    else if(instruction.includes("frying chicken") || ("fry chicken") || ("fry")) {
        return getStaticResource(path + 'chicken_frying.gif');
    }

    else if(instruction.includes("cook chicken in oil")) {
        return getStaticResource(path + 'chicken_oil_cooking.gif');
    }

    else if(instruction.includes("beat eggs and water")) {
        return getStaticResource(path + 'chicken_beating_egg.gif');
    }

    else if(instruction.includes("cheese slice") || ("until cheese is melted")) {
        return getStaticResource(path + 'chicken_cheese_topping.gif');
    }
